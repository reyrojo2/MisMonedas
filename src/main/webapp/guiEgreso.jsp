            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a class="btn btn-info"
			           href="<%= request.getContextPath() %>/montosController?tipo=egreso">
			          <i class="bi bi-plus-circle"></i> Ver Reporte de egresos
			        </a>
                </div>

                <div class="bg-white p-4 rounded shadow mt-3">
                    <h3 class="text-center mb-4 text-secondary">Registrar Nuevo Egreso</h3>
                    <form action="montosController?tipo=egreso&accion=guardar" method="post" class="needs-validation" novalidate>
                        <div class="mb-3">
